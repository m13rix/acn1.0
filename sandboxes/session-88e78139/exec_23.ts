...
const res = await search.search('"-1718501946501227358" Minecraft Java 1.21 seed village lava pool ruined portal', { topic: 'general', searchDepth: 'advanced', maxResults: 10, output: 'full' });
