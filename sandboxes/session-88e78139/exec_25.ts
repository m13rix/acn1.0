...
const pending3 = await strategy.routes.listPendingExpansion(sid, 2);
const can = await strategy.cycle.canAdvance(sid);
console.log(JSON.stringify({ pending3, can }, null, 2));
})().then(() => {
